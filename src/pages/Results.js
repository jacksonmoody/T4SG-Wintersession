...
function Results(props) {
    ...
    const body = users.map((user) => ([user.name, user.email, user.description, arrayToString(user.clubs), user.gender, user.numOfBlockmates, arrayToString(user.concentration), user.cleanliness, user.sleeptime, arrayToString(user.hobbies), user.roomloudness, user.lookingforgroup, user.dorm, user.TypeofPerson]));
