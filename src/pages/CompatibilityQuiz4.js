    ...
    <Container component="main" maxWidth="xs" >
      <Box
        ...
        <Box sx = {{marginTop: 3, marginBottom: 3}}>
          <Typography align="center" variant="h4"  sx={{ fontWeight: 'bold'}}> Compatability Quiz </Typography>
          <Typography align="center" variant="h6" sx={{ fontWeight: 'bold'}}> Q4: What type of person are you? </Typography>
        </Box>
